@extends('adminHP.admin.layout_login')
...
<div class="container">
    ...
    <div id="logreg-forms">
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center"> Đăng Nhập</h1><hr>
           ...
           <hr>
            ...
            <form action="/signup/" class="form-signup">
                ...
                <a href="{{url('/')}}" id="cancel_signup"><i class="fas fa-angle-left"></i> Back</a>
            </form>
            <br>
