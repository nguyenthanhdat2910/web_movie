...
<div class="row container" id="wrapper">
    <div class="halim-panel-filter">
       {{-- <div class="panel-heading">
          <div class="row">
             <div class="col-xs-6">
                <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{$danhmuc_slug->title}}</a> <span class="breadcrumb_last" aria-current="page"></span></span></span></div>
             </div>
          </div>
       </div> --}}
    ...
    <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
       <section>
          <div class="section-bar clearfix">
             <h1 class="section-title"><span>{{$danhmuc_slug->title}}</span></h1>
          </div>
          <div class="section-bar clearfix">
